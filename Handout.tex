...
\end{lstlisting}
    ...
    It seems that there's no way to achieve this, unless we define some special "marks" for starting a new line. These marks are called "Control Characters". For example, '\bs n' is a mark for starting a new line, and will be viewed as a character. Thus, to achieve the goal, we can write a program like this
